#Exercise to approximate the square root of a number without numpy
import math

no = input("Input number: ") #Gets user input
...
try: #Checks if user inputted an integer
    ...
    while count < no:
        if count ** 2 == no: #Checks if the number is already a perfect square
    ...
    if isPerfectSquare == False:
        ...
        print(f"The square root of {no} is approximately {result}.")    
